...
Run it to generate the response surface::
	...
	~/memosa/src/puq/examples/test1> puq start test1
	...
	~/memosa/src/puq/examples/test1> mv sweep_145215760.hdf5 test1.hdf5
...
Then you do 'puq plot --using filename'::
	...
	/memosa/src/puq/examples/test1> puq plot --using new_pdfs.py  test1.hdf5 
